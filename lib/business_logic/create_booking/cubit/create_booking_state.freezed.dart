...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateBookingState);
}
...
/// @nodoc
class $CreateBookingStateCopyWith<$Res>  {
$CreateBookingStateCopyWith(CreateBookingState _, $Res Function(CreateBookingState) __);
}
...
class _Initial implements CreateBookingState {
  const _Initial();
...
class _Loading implements CreateBookingState {
  const _Loading();
...
@override
String toString() {
  return 'CreateBookingState.loading()';
}
...
class _Success implements CreateBookingState {
  const _Success();
...
@override
String toString() {
  return 'CreateBookingState.success()';
}
...
class _Error implements CreateBookingState {
...
@override
String toString() {
  return 'CreateBookingState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CreateBookingStateCopyWith<$Res> {
