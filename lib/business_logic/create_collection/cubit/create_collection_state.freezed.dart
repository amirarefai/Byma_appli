...
part of 'create_collection_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateCollectionState);
}
...
/// @nodoc
class $CreateCollectionStateCopyWith<$Res>  {
$CreateCollectionStateCopyWith(CreateCollectionState _, $Res Function(CreateCollectionState) __);
}
...
class _Initial implements CreateCollectionState {
  const _Initial();
...
@override
String toString() {
  return 'CreateCollectionState.initial()';
}
...
class _Loading implements CreateCollectionState {
  const _Loading();
...
@override
String toString() {
  return 'CreateCollectionState.loading()';
}
...
class _Success implements CreateCollectionState {
  const _Success();
...
@override
String toString() {
  return 'CreateCollectionState.success()';
}
...
class _Error implements CreateCollectionState {
...
@override
String toString() {
  return 'CreateCollectionState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CreateCollectionStateCopyWith<$Res> {
