...
part of 'create_deposit_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateDepositState);
}
...
/// @nodoc
class $CreateDepositStateCopyWith<$Res>  {
$CreateDepositStateCopyWith(CreateDepositState _, $Res Function(CreateDepositState) __);
}


/// Adds pattern-matching-related methods to [CreateDepositState].
extension CreateDepositStatePatterns on CreateDepositState {
...
class _Initial implements CreateDepositState {
  const _Initial();
...
class _Loading implements CreateDepositState {
  const _Loading();
...
class _Success implements CreateDepositState {
  const _Success();
...
@override
String toString() {
  return 'CreateDepositState.success()';
}
...
class _Error implements CreateDepositState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of CreateDepositState
...
@override
String toString() {
  return 'CreateDepositState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CreateDepositStateCopyWith<$Res> {
