...
part of 'create_withdraw_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateWithdrawState);
}
...
/// @nodoc
class $CreateWithdrawStateCopyWith<$Res>  {
$CreateWithdrawStateCopyWith(CreateWithdrawState _, $Res Function(CreateWithdrawState) __);
}


/// Adds pattern-matching-related methods to [CreateWithdrawState].
extension CreateWithdrawStatePatterns on CreateWithdrawState {
...
class _Initial implements CreateWithdrawState {
  const _Initial();
...
class _Loading implements CreateWithdrawState {
  const _Loading();
...
class _Success implements CreateWithdrawState {
  const _Success();
...
@override
String toString() {
  return 'CreateWithdrawState.success()';
}
...
class _Error implements CreateWithdrawState {
  const _Error(this.message);
  

 final  String message;

/// Create a copy of CreateWithdrawState
...
@override
String toString() {
  return 'CreateWithdrawState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CreateWithdrawStateCopyWith<$Res> {
