...
return conflict(_that.reason);case InternalServerError() when internalServerError != null:
...
return conflict(_that.reason);case InternalServerError():
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Conflict&&(identical(other.reason, reason) || other.reason == reason));
}
