                      ...
                      return state.when(
                        ...
                        success: (favoriteRooms) {
                          ...
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              _buildSectionHeader(theme, 'Favorite Rooms'.tr()),
                              SizedBox(
                                height: 300,
                                  ...
                                  itemBuilder: (context, index) {
                                    return SizedBox(
                                      width:
                                          ...
                                          0.8, // استخدم نفس نسبة عرض كرت الفنادق بالضبط (0.82 بدلاً من 0.8)
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                RoomDetailsScreen(roomId: int.parse(room.id.toString())),
          ),
        );
      },
      child: Container(
                    ...
                    Positioned(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          borderRadius: BorderRadius.circular(14),
                          onTap: () {
                            // 1. Optimistic removal from the UI list
                            context
                                .read<FavoriteRoomsCubit>()
                                .removeRoomOptimistically(favoriteRoom.id);

                            // 2. Execute the API call to remove the favorite room
                            context
                                .read<ToggleFavoriteRoomsCubit>()
                                .removeFavorite(favoriteRoom.id);
                          },
                          child: Container(
                            width: 42,
                            height: 42,
