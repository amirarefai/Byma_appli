...
//   static void show(BuildContext context, RoomDetailsModel room) {
...
//       ),
//       builder: (_) => AddToCollectionSheet(room: room),
//     );
//   }
...
//                       newCol.items.add(
//                         CollectionItem(
//                           id: widget.room.title,
//                           nameEn: widget.room.title,
//                           nameAr: widget.room.title,
//                           imageUrl: '',
...
//                       SnackBar(
//                         content: Text(
//                           'تم إنشاء مجموعة "$name" وحفظ الغرفة فيها',
//                         ),
//                       ),
//                     );
//                   }
...
//                     (item) => item.id == widget.room.title,
//                   );
